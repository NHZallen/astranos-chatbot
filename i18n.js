window.i18n = {
    'zh-TW': {
        ...
        versionNumber: 'Astra-nos-16.1.1',
        ...
        model_gemini_2_5_flash_lite_pv_desc_tier_paid: '百萬輸入/0.10$、百萬輸出/0.30$',
        ...
        'model_gpt_5.1_desc_tier_free': '不提供',
        'model_gpt_5.1_desc_tier_paid': '百萬輸入/1.25$、百萬輸出/10$',
        ...
        model_grok_4_1_fast_desc_tier_paid: '百萬輸入/0$、百萬輸出/0$ (限時免費)',
        model_grok_4_1_fast_free_desc_tier_free: '費用-免費',
        model_grok_4_1_fast_free_desc_tier_paid: '不提供',
        ...
        model_qwen3_coder_exact_desc_tier_paid: '百萬輸入/0.38$、百萬輸出/1.53$',
        model_qwen3_vl_8b_instruct_desc_tier_free: '不提供',
        model_qwen3_vl_8b_instruct_desc_tier_paid: '百萬輸入/0.18$、百萬輸出/0.69$',
        model_qwen3_vl_32b_instruct_desc_tier_free: '不提供',
        model_qwen3_vl_32b_instruct_desc_tier_paid: '百萬輸入/0.35$、百萬輸出/1.10$',
        ...
        model_kimi_k2_thinking_desc_tier_free: '不提供',
        model_kimi_k2_thinking_desc_tier_paid: '百萬輸入/0.60$、百萬輸出/2.50$',
        // gemini Paid
        model_gemini_3_pro_preview_desc_tier_free: '不提供',
        model_gemini_3_pro_preview_desc_tier_paid: '百萬輸入/2$、百萬輸出/12$',
        model_gemini_3_pro_image_preview_desc_tier_free: '不提供',
        model_gemini_3_pro_image_preview_desc_tier_paid: '2 $/M 輸入, 12 $/M 輸出',
        model_gemini_2_5_flash_image_desc_tier_free: '不提供',
        model_gemini_2_5_flash_image_desc_tier_paid: '0.30 $/M 輸入, 2.50 $/M 輸出',
        // Official Astras
    ...
    'en': {
        ...
        model_gemini_2_5_flash_lite_pv_desc_tier_paid: '$0.10/M input, $0.30/M output',
        ...
        'model_gpt_5.1_desc_tier_free': 'Not available',
        'model_gpt_5.1_desc_tier_paid': '$1.25/M input, $10/M output',
        ...
        model_grok_4_1_fast_desc_tier_paid: '$0/M input, $0/M output (Temporarily Free)',
        model_grok_4_1_fast_free_desc_tier_free: 'Cost - Free',
        model_grok_4_1_fast_free_desc_tier_paid: 'Not available',
        ...
        model_qwen3_coder_exact_desc_tier_paid: '$0.38/M input, $1.53/M output',
        model_qwen3_vl_8b_instruct_desc_tier_free: 'Not available',
        model_qwen3_vl_8b_instruct_desc_tier_paid: '$0.18/M input, $0.69/M output',
        model_qwen3_vl_32b_instruct_desc_tier_free: 'Not available',
        model_qwen3_vl_32b_instruct_desc_tier_paid: '$0.35/M input, $1.10/M output',
        ...
        model_qwen2_5_vl_72b_instruct_desc_tier_free: 'Not available',
        model_qwen2_5_vl_72b_instruct_desc_tier_paid: '$0.08/M input, $0.33/M output',
        ...
        model_gemini_3_pro_image_preview_desc_tier_free: 'Not available',
        model_gemini_3_pro_image_preview_desc_tier_paid: '$2/M input, $12/M output',
        model_gemini_2_5_flash_image_desc_tier_free: 'Not available',
        model_gemini_2_5_flash_image_desc_tier_paid: '$0.30/M input, $2.50/M output',
        // Official Astras
    ...
    'fr': {
        ...
        model_gemini_2_5_flash_lite_pv_desc_tier_paid: '0.10 $/M entrée, 0.30 $/M sortie',
        ...
        'model_gpt_5.1_desc_tier_free': 'Non disponible',
        'model_gpt_5.1_desc_tier_paid': '1,25 $/M entrée, 10 $/M sortie',
        ...
        model_grok_4_1_fast_desc_tier_paid: '0,00 $/M entrée, 0,00 $/M sortie (Temporairement Gratuit)',
        model_grok_4_1_fast_free_desc_tier_free: 'Coût - Gratuit',
        model_grok_4_1_fast_free_desc_tier_paid: 'Non disponible',
        ...
        model_qwen3_coder_exact_desc_tier_paid: '0,38 $/M entrée, 1,53 $/M sortie',
        model_qwen3_vl_8b_instruct_desc_tier_free: 'Non disponible',
        model_qwen3_vl_8b_instruct_desc_tier_paid: '0,18 $/M entrée, 0,69 $/M sortie',
        model_qwen3_vl_32b_instruct_desc_tier_free: 'Non disponible',
        model_qwen3_vl_32b_instruct_desc_tier_paid: '0,35 $/M entrée, 1,10 $/M sortie',
        ...
        model_qwen2_5_vl_72b_instruct_desc_tier_free: 'Non disponible',
        model_qwen2_5_vl_72b_instruct_desc_tier_paid: '0,08 $/M entrée, 0,33 $/M sortie',
        ...
        model_gemini_3_pro_preview_desc_tier_free: 'Non disponible',
        model_gemini_3_pro_preview_desc_tier_paid: '2 $/M entrée, 12 $/M sortie',
        model_gemini_3_pro_image_preview_desc_tier_free: 'Non disponible',
        model_gemini_3_pro_image_preview_desc_tier_paid: '2 $/M entrée, 12 $/M sortie',
        model_gemini_2_5_flash_image_desc_tier_free: 'Non disponible',
        model_gemini_2_5_flash_image_desc_tier_paid: '0.30 $/M entrée, 2.50 $/M sortie',
        // Official Astras
