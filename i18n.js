window.i18n = {
    'zh-TW': {
        ...
        versionNumber: 'Astra-nos-15.7.4', // <-- 修改
        ...
        model_deepseek_v3_1_tier_free: '費用-免費 (20次/分鐘、50次/天)',
        model_deepseek_v3_1_tier_paid: '不提供',
        model_gpt_oss_20b_tier_free: '費用-免費 (20次/分鐘、50次/天)',
        model_gpt_oss_20b_tier_paid: '不提供',
        model_qwen3_235b_tier_free: '費用-免費 (20次/分鐘、50次/天)',
        model_qwen3_235b_tier_paid: '不提供',

        // GPT-5 Models
        model_gpt_5_pro_tier_free: '不提供',
        model_gpt_5_pro_tier_paid: '百萬輸入/15$、百萬輸出/120$',
        model_gpt_5_tier_free: '不提供',
        model_gpt_5_tier_paid: '百萬輸入/1.25$、百萬輸出/10$',
        model_gpt_5_mini_tier_free: '不提供',
        model_gpt_5_mini_tier_paid: '百萬輸入/0.25$、百萬輸出/2$',
        model_gpt_5_nano_tier_free: '不提供',
        model_gpt_5_nano_tier_paid: '百萬輸入/0.05$、百萬輸出/0.40$',
        model_gpt_5_codex_tier_free: '不提供',
        model_gpt_5_codex_tier_paid: '百萬輸入/1.25$、百萬輸出/10$',

        model_grok_4_fast_tier_free: '不提供',
        model_grok_4_fast_tier_paid: '百萬輸入/0.20$、百萬輸出/0.50$',
        model_grok_code_fast_1_tier_free: '不提供',
        model_grok_code_fast_1_tier_paid: '百萬輸入/0.20$、百萬輸出/1.50$',
        model_gpt_4_1_mini_tier_free: '不提供',
        model_gpt_4_1_mini_tier_paid: '百萬輸入/0.40$、百萬輸出/1.60$',
        model_qwen3_coder_tier_free: '不提供',
        model_qwen3_coder_tier_paid: '百萬輸入/0.22$、百萬輸出/0.95$',
    ...
    'en': {
        ...
        // Model Descriptions & Limits
        model_gemini_2_5_pro_tier_free: 'Cost - Free (5 req/min, 100 req/day)',
        model_gemini_2_5_pro_tier_paid: '$1.25/M input, $10/M output',
        model_gemini_2_5_flash_pv_tier_free: 'Cost - Free (10 req/min, 250 req/day)',
        model_gemini_2_5_flash_pv_tier_paid: '$0.3/M input, $2.5/M output',
        model_gemini_2_5_flash_tier_free: 'Cost - Free (10 req/min, 250 req/day)',
        model_gemini_2_5_flash_tier_paid: '$0.3/M input, $2.5/M output',
        model_gemini_2_5_flash_lite_pv_tier_free: 'Cost - Free (15 req/min, 1000 req/day)',
        model_gemini_2_5_flash_lite_pv_tier_paid: '$0.1/M input, $0.4/M output',
        model_deepseek_v3_1_tier_free: 'Cost - Free (20 req/min, 50 req/day)',
        model_deepseek_v3_1_tier_paid: 'Not available',
        model_gpt_oss_20b_tier_free: 'Cost - Free (20 req/min, 50 req/day)',
        model_gpt_oss_20b_tier_paid: 'Not available',
        model_qwen3_235b_tier_free: 'Cost - Free (20 req/min, 50 req/day)',
        model_qwen3_235b_tier_paid: 'Not available',

        model_gpt_5_pro_tier_free: 'Not available',
        model_gpt_5_pro_tier_paid: '$15/M input tokens, $120/M output tokens',
        model_gpt_5_tier_free: 'Not available',
        model_gpt_5_tier_paid: '$1.25/M input tokens, $10/M output tokens',
        model_gpt_5_mini_tier_free: 'Not available',
        model_gpt_5_mini_tier_paid: '$0.25/M input tokens, $2/M output tokens',
        model_gpt_5_nano_tier_free: 'Not available',
        model_gpt_5_nano_tier_paid: '$0.05/M input tokens, $0.40/M output tokens',
        model_gpt_5_codex_tier_free: 'Not available',
        model_gpt_5_codex_tier_paid: '$1.25/M input tokens, $10/M output tokens',

        model_grok_4_fast_tier_free: 'Not available',
        model_grok_4_fast_tier_paid: '$0.20/M input tokens, $0.50/M output tokens',
        model_grok_code_fast_1_tier_free: 'Not available',
        model_grok_code_fast_1_tier_paid: '$0.20/M input tokens, $1.50/M output tokens',
        model_gpt_4_1_mini_tier_free: 'Not available',
        model_gpt_4_1_mini_tier_paid: '$0.40/M input tokens, $1.60/M output tokens',
        model_qwen3_coder_tier_free: 'Not available',
        model_qwen3_coder_tier_paid: '$0.22/M input tokens, $0.95/M output tokens',
    ...
    'fr': {
        ...
        // Model Descriptions & Limits
        model_gemini_2_5_pro_tier_free: 'Coût - Gratuit (5 req/min, 100 req/jour)',
        model_gemini_2_5_pro_tier_paid: '1,25 $/M entrée, 10 $/M sortie',
        model_gemini_2_5_flash_pv_tier_free: 'Coût - Gratuit (10 req/min, 250 req/jour)',
        model_gemini_2_5_flash_pv_tier_paid: '0,3 $/M entrée, 2,5 $/M sortie',
        model_gemini_2_5_flash_tier_free: 'Coût - Gratuit (10 req/min, 250 req/jour)',
        model_gemini_2_5_flash_tier_paid: '0,3 $/M entrée, 2,5 $/M sortie',
        model_gemini_2_5_flash_lite_pv_tier_free: 'Coût - Gratuit (15 req/min, 1000 req/jour)',
        model_gemini_2_5_flash_lite_pv_tier_paid: '0,1 $/M entrée, 0,4 $/M sortie',
        model_deepseek_v3_1_tier_free: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_deepseek_v3_1_tier_paid: 'Non disponible',
        model_gpt_oss_20b_tier_free: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_gpt_oss_20b_tier_paid: 'Non disponible',
        model_qwen3_235b_tier_free: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_qwen3_235b_tier_paid: 'Non disponible',

        model_gpt_5_pro_tier_free: 'Non disponible',
        model_gpt_5_pro_tier_paid: '15 $/M entrée, 120 $/M sortie',
        model_gpt_5_tier_free: 'Non disponible',
        model_gpt_5_tier_paid: '1,25 $/M entrée, 10 $/M sortie',
        model_gpt_5_mini_tier_free: 'Non disponible',
        model_gpt_5_mini_tier_paid: '0,25 $/M entrée, 2 $/M sortie',
        model_gpt_5_nano_tier_free: 'Non disponible',
        model_gpt_5_nano_tier_paid: '0,05 $/M entrée, 0,40 $/M sortie',
        model_gpt_5_codex_tier_free: 'Non disponible',
        model_gpt_5_codex_tier_paid: '1,25 $/M entrée, 10 $/M sortie',

        model_grok_4_fast_tier_free: 'Non disponible',
        model_grok_4_fast_tier_paid: '0,20 $/M entrée, 0,50 $/M sortie',
        model_grok_code_fast_1_tier_free: 'Non disponible',
        model_grok_code_fast_1_tier_paid: '0,20 $/M entrée, 1,50 $/M sortie',
        model_gpt_4_1_mini_tier_free: 'Non disponible',
        model_gpt_4_1_mini_tier_paid: '0,40 $/M entrée, 1,60 $/M sortie',
        model_qwen3_coder_tier_free: 'Non disponible',
        model_qwen3_coder_tier_paid: '0,22 $/M entrée, 0,95 $/M sortie',
