window.i18n = {
    'zh-TW': {
        ...
        submitting: '提交中...',
        // Model Descriptions & Limits (Merged Versions)
        model_gemini_2_5_pro_desc: '費用-免費 (5次/分鐘、100次/天) 或 付費 (百萬輸入/1.25$、百萬輸出/10$)',
        model_gemini_2_5_flash_pv_desc: '費用-免費 (10次/分鐘、250次/天) 或 付費 (百萬輸入/0.3$、百萬輸出/2.5$)',
        model_gemini_2_5_flash_desc: '費用-免費 (10次/分鐘、250次/天) 或 付費 (百萬輸入/0.3$、百萬輸出/2.5$)',
        model_gemini_2_5_flash_lite_pv_desc: '費用-免費 (15次/分鐘、1000次/天) 或 付費 (百萬輸入/0.1$、百萬輸出/0.4$)',
        model_deepseek_v3_1_desc: '費用-免費 (20次/分鐘、50次/天)',
        model_gpt_oss_20b_desc: '費用-免費 (20次/分鐘、50次/天)',
        model_qwen3_235b_desc: '費用-免費 (20次/分鐘、50次/天)',
        model_deepseek_r1t2_chimera_desc: '費用-免費 (20次/分鐘、50次/天)',
        model_meta_llama_llama_3_3_70b_instruct_desc: '費用-免費 (20次/分鐘、50次/天)',
        model_andromeda_alpha_desc: '實驗性多模態模型，免費使用，具備圖像識別能力。',
        model_gpt_5_pro_desc: '百萬輸入/15$、百萬輸出/120$',
        model_gpt_5_desc: '百萬輸入/1.25$、百萬輸出/10$',
        model_gpt_5_mini_desc: '百萬輸入/0.25$、百萬輸出/2$',
        model_gpt_5_nano_desc: '百萬輸入/0.05$、百萬輸出/0.40$',
        model_gpt_5_codex_desc: '百萬輸入/1.25$、百萬輸出/10$',
        model_gpt_4_1_desc: '百萬輸入/2$、百萬輸出/8$',
        model_gpt_4_1_mini_desc: '百萬輸入/0.40$、百萬輸出/1.60$',
        model_gpt_4_1_nano_desc: '百萬輸入/0.10$、百萬輸出/0.40$',
        model_o3_desc: '百萬輸入/2$、百萬輸出/8$',
        model_o3_mini_high_desc: '百萬輸入/1.10$、百萬輸出/4.40$',
        model_gpt_oss_120b_desc: '百萬輸入/0.04$、百萬輸出/0.40$',
        model_claude_sonnet_4_5_desc: '百萬輸入/3$、百萬輸出/15$',
        model_claude_haiku_4_5_desc: '百萬輸入/1$、百萬輸出/5$',
        model_claude_sonnet_4_desc: '百萬輸入/3$、百萬輸出/15$',
        model_perplexity_sonar_deep_research_desc: '百萬輸入/2$、百萬輸出/8$',
        model_perplexity_sonar_desc: '百萬輸入/1$、百萬輸出/1$',
        model_deepseek_v3_1_terminus_desc: '百萬輸入/0.23$、百萬輸出/0.90$',
        model_grok_4_fast_desc: '百萬輸入/0.20$、百萬輸出/0.50$',
        model_grok_code_fast_1_desc: '百萬輸入/0.20$、百萬輸出/1.50$',
        model_qwen3_coder_desc: '百萬輸入/0.22$、百萬輸出/0.95$',
        model_qwen3_vl_8b_instruct_desc: '百萬輸入/0.18$、百萬輸出/0.69$',
        model_qwen3_vl_235b_instruct_desc: '百萬輸入/0.30$、百萬輸出/1.20$',
        model_qwen_qwen3_235b_a22b_2507_desc: '百萬輸入/0.08$、百萬輸出/0.55$',
        model_qwen_qwen3_235b_a22b_thinking_2507_desc: '百萬輸入/0.11$、百萬輸出/0.60$',
        model_qwen2_5_vl_72b_instruct_desc: '費用-免費 (20次/分鐘、50次/天)',
        model_kimi_k2_0905_desc: '百萬輸入/0.39$、百萬輸出/1.90$',
        // Official Astras
    ...
    'en': {
        ...
        model_gemini_2_5_pro_desc: 'Cost - Free (5 req/min, 100 req/day) or Paid ($1.25/M input, $10/M output)',
        model_gemini_2_5_flash_pv_desc: 'Cost - Free (10 req/min, 250 req/day) or Paid ($0.3/M input, $2.5/M output)',
        model_gemini_2_5_flash_desc: 'Cost - Free (10 req/min, 250 req/day) or Paid ($0.3/M input, $2.5/M output)',
        model_gemini_2_5_flash_lite_pv_desc: 'Cost - Free (15 req/min, 1000 req/day) or Paid ($0.1/M input, $0.4/M output)',
        model_deepseek_v3_1_desc: 'Cost - Free (20 req/min, 50 req/day)',
        model_gpt_oss_20b_desc: 'Cost - Free (20 req/min, 50 req/day)',
        model_qwen3_235b_desc: 'Cost - Free (20 req/min, 50 req/day)',
        model_deepseek_r1t2_chimera_desc: 'Cost - Free (20 req/min, 50 req/day)',
        model_meta_llama_llama_3_3_70b_instruct_desc: 'Cost - Free (20 req/min, 50 req/day)',
        model_andromeda_alpha_desc: 'Experimental multimodal model, free to use, with image recognition capabilities.',
        model_gpt_5_pro_desc: '$15/M input, $120/M output',
        model_gpt_5_desc: '$1.25/M input, $10/M output',
        model_gpt_5_mini_desc: '$0.25/M input, $2/M output',
        model_gpt_5_nano_desc: '$0.05/M input, $0.40/M output',
        model_gpt_5_codex_desc: '$1.25/M input, $10/M output',
        model_gpt_4_1_desc: '$2/M input, $8/M output',
        model_gpt_4_1_mini_desc: '$0.40/M input, $1.60/M output',
        model_gpt_4_1_nano_desc: '$0.10/M input, $0.40/M output',
        model_o3_desc: '$2/M input, $8/M output',
        model_o3_mini_high_desc: '$1.10/M input, $4.40/M output',
        model_gpt_oss_120b_desc: '$0.04/M input, $0.40/M output',
        model_claude_sonnet_4_5_desc: '$3/M input, $15/M output',
        model_claude_haiku_4_5_desc: '$1/M input, $5/M output',
        model_claude_sonnet_4_desc: '$3/M input, $15/M output',
        model_perplexity_sonar_deep_research_desc: '$2/M input, $8/M output',
        model_perplexity_sonar_desc: '$1/M input, $1/M output',
        model_deepseek_v3_1_terminus_desc: '$0.23/M input, $0.90/M output',
        model_grok_4_fast_desc: '$0.20/M input, $0.50/M output',
        model_grok_code_fast_1_desc: '$0.20/M input, $1.50/M output',
        model_qwen3_coder_desc: '$0.22/M input, $0.95/M output',
        model_qwen3_vl_8b_instruct_desc: '$0.18/M input, $0.69/M output',
        model_qwen3_vl_235b_instruct_desc: '$0.30/M input, $1.20/M output',
        model_qwen_qwen3_235b_a22b_2507_desc: '$0.08/M input, $0.55/M output',
        model_qwen_qwen3_235b_a22b_thinking_2507_desc: '$0.11/M input, $0.60/M output',
        model_qwen2_5_vl_72b_instruct_desc: 'Cost - Free (20 req/min, 50 req/day)',
        model_kimi_k2_0905_desc: '$0.39/M input, $1.90/M output',
        // Official Astras
    ...
    'fr': {
        ...
        // Model Descriptions & Limits
        model_gemini_2_5_pro_desc: 'Coût - Gratuit (5 req/min, 100 req/jour) ou Payant (1,25 $/M entrée, 10 $/M sortie)',
        model_gemini_2_5_flash_pv_desc: 'Coût - Gratuit (10 req/min, 250 req/jour) ou Payant (0,3 $/M entrée, 2,5 $/M sortie)',
        model_gemini_2_5_flash_desc: 'Coût - Gratuit (10 req/min, 250 req/jour) ou Payant (0,3 $/M entrée, 2,5 $/M sortie)',
        model_gemini_2_5_flash_lite_pv_desc: 'Coût - Gratuit (15 req/min, 1000 req/jour) ou Payant (0,1 $/M entrée, 0,4 $/M sortie)',
        model_deepseek_v3_1_desc: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_gpt_oss_20b_desc: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_qwen3_235b_desc: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_deepseek_r1t2_chimera_desc: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_meta_llama_llama_3_3_70b_instruct_desc: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_andromeda_alpha_desc: 'Modèle multimodal expérimental, gratuit, avec capacités de reconnaissance d\'image.',
        model_gpt_5_pro_desc: '15 $/M entrée, 120 $/M sortie',
        model_gpt_5_desc: '1,25 $/M entrée, 10 $/M sortie',
        model_gpt_5_mini_desc: '0,25 $/M entrée, 2 $/M sortie',
        model_gpt_5_nano_desc: '0,05 $/M entrée, 0,40 $/M sortie',
        model_gpt_5_codex_desc: '1,25 $/M entrée, 10 $/M sortie',
        model_gpt_4_1_desc: '2 $/M entrée, 8 $/M sortie',
        model_gpt_4_1_mini_desc: '0,40 $/M entrée, 1,60 $/M sortie',
        model_gpt_4_1_nano_desc: '0,10 $/M entrée, 0,40 $/M sortie',
        model_o3_desc: '2 $/M entrée, 8 $/M sortie',
        model_o3_mini_high_desc: '1,10 $/M entrée, 4,40 $/M sortie',
        model_gpt_oss_120b_desc: '0,04 $/M entrée, 0,40 $/M sortie',
        model_claude_sonnet_4_5_desc: '3 $/M entrée, 15 $/M sortie',
        model_claude_haiku_4_5_desc: '1 $/M entrée, 5 $/M sortie',
        model_claude_sonnet_4_desc: '3 $/M entrée, 15 $/M sortie',
        model_perplexity_sonar_deep_research_desc: '2 $/M entrée, 8 $/M sortie',
        model_perplexity_sonar_desc: '1 $/M entrée, 1 $/M sortie',
        model_deepseek_v3_1_terminus_desc: '0,23 $/M entrée, 0,90 $/M sortie',
        model_grok_4_fast_desc: '0,20 $/M entrée, 0,50 $/M sortie',
        model_grok_code_fast_1_desc: '0,20 $/M entrée, 1,50 $/M sortie',
        model_qwen3_coder_desc: '0,22 $/M entrée, 0,95 $/M sortie',
        model_qwen3_vl_8b_instruct_desc: '0,18 $/M entrée, 0,69 $/M sortie',
        model_qwen3_vl_235b_instruct_desc: '0,30 $/M entrée, 1,20 $/M sortie',
        model_qwen_qwen3_235b_a22b_2507_desc: '0,08 $/M entrée, 0,55 $/M sortie',
        model_qwen_qwen3_235b_a22b_thinking_2507_desc: '0,11 $/M entrée, 0,60 $/M sortie',
        model_qwen2_5_vl_72b_instruct_desc: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_kimi_k2_0905_desc: '0,39 $/M entrée, 1,90 $/M sortie',
        // Official Astras
