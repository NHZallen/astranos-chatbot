window.i18n = {
    'zh-TW': {
        ...
        // Model Descriptions
        model_descriptions_title: "探索為您量身打造的 AI 模型",
        model_descriptions_subtitle: "我們提供一系列為不同任務量身打造的頂尖模型。使用下方的篩選器，找到最適合您當前任務的強力夥伴。",
        desc_gemini_2_5_pro: "由 Google 開發的旗艦模型。原生支援圖片、音訊與影片分析，擁有高達 200 萬 token 的超長上下文處理能力，極度適合進行大規模文件審閱、複雜的多模態推理與深度程式碼分析。",
        desc_gemini_2_5_flash_pv: "Gemini 2.5 Flash 的預覽版本，專為需要極致速度與效率的應用而生。適合進行高流量的摘要、翻譯或即時對話任務，是成本效益極高的選擇。",
        desc_gemini_2_5_flash: "Google 推出的輕量級高速模型，在保持高品質輸出的同時，大幅降低了延遲與成本。非常適合需要快速回應、大規模部署的場景，例如聊天機器人或內容分類。",
        desc_gemini_2_5_flash_lite_pv: "Flash 系列中最輕快的預覽版本，為行動裝置與邊緣運算優化。擁有驚人的回應速度，適合執行簡單的指令、文字過濾或需要嵌入式AI的應用。",
        desc_gpt_5_pro: "OpenAI 的頂級旗艦模型，具備目前最強的通用推理能力與多模態理解力。適合處理最複雜、需要深度思考與創意的任務，是解決棘手問題的首選。",
        desc_gpt_5: "OpenAI 的核心高效能模型，在通用知識、推理與多語言能力上達到卓越平衡。是處理多數專業寫作、內容生成與複雜問答的理想選擇。",
        desc_gpt_5_mini: "GPT-5 系列的輕量級主力，以極高的性價比提供強大的通用能力。適合日常工作、文案撰寫、郵件草擬等需要快速且可靠回應的場景。",
        desc_gpt_5_nano: "GPT-5 系列中最經濟、最快速的型號。專為需要極速回應的簡單任務設計，例如文字分類、關鍵字提取或簡單的客戶服務問答。",
        desc_gpt_4_1": "OpenAI 的進階大型語言模型，在 GPT-4 的基礎上進行了改進，提供更強的推理和遵循指令的能力，適合多數專業場景。",
        desc_gpt_4_1_mini": "GPT-4.1 的輕量版本，在保持較高品質的同時，提供了更快的速度和更低的成本，適合需要快速回應的平衡型應用。",
        desc_gpt_4_1_nano": "GPT-4.1 系列中最快、最經濟的版本，專為簡單、高頻率的任務優化，例如文字分類、情感分析或簡單的問答。",
        desc_gpt_5_codex: "專為程式設計而生的頂級模型。不僅能生成高品質程式碼，更能深入理解現有程式碼庫、除錯、撰寫測試案例，並提供架構建議，是專業開發者的強力輔助工具。",
        desc_o3": "OpenAI 的 o3 系列模型之一，專為需要多步驟思考、邏輯鏈推理的複雜任務設計。它在解決數學難題、進行策略規劃或分析複雜程式碼方面表現卓越。",
        desc_o3_mini_high": "O3 Mini 系列中的高規格版本，以更低的成本提供了接近 O3 的強大推理能力，是需要複雜思考但預算有限時的高性價比選擇。",
        desc_gpt_oss_120b": "OpenAI 推出的大型開源模型，擁有 1200 億參數。它在通用知識、推理和程式碼能力方面表現均衡，是開源社群中的一個強大選項。",
        desc_claude_sonnet_4_5": "Anthropic 的主力模型，在速度、智慧與成本之間取得了絕佳平衡。特別擅長處理企業級任務，如資料分析、銷售預測與複雜的 RAG 應用，並在準確性上領先同級模型。",
        desc_claude_haiku_4_5": "Anthropic 速度最快的模型，擁有頂級的視覺處理能力。適合需要快速回應並理解圖片內容的場景，例如即時客服、內容審核或從圖片中快速提取資訊。",
        desc_claude_sonnet_4": "Anthropic 的 Claude 4 系列模型之一，專為需要高可靠性和安全性的企業級應用設計，特別強調減少有害輸出和提高遵循指令的準確性。",
        desc_sonar_deep_research": "Perplexity AI 專為深度研究打造的模型。它能進行多步驟的網路搜尋、分析並綜合大量來源的資訊，最終產出富有洞見的詳細報告。",
        desc_sonar": "Perplexity AI 的核心線上模型，結合了大型語言模型與即時網路搜尋的能力，能夠為需要最新資訊的問題提供準確、附帶來源的答案。",
        desc_deepseek_v3_1_terminus": "深度求索的旗艦付費模型，在程式碼和數學領域處於世界領先地位。它不僅能編寫高品質程式碼，還能解決複雜的數學和邏輯問題，是技術專家的得力助手。",
        desc_grok_4_fast": "由 x-ai 開發，以即時資訊處理和獨特的幽默感著稱。特別適合需要結合最新網路資訊、進行快速事實查詢或需要帶有強烈個性的創意寫作任務。",
        desc_grok_code_fast_1": "x-ai 專為程式碼任務優化的模型，提供快速的程式碼生成、補全和除錯能力，旨在提升開發者的生產力。",
        desc_qwen3_coder": "阿里巴巴通義千問系列的程式碼專用模型，支援多種程式語言，並在程式碼生成和修復方面進行了深度優化。",
        desc_qwen3_vl_235b": "通義千問的頂級視覺語言模型，能夠以極高的精度理解和分析圖片內容，並根據複雜的指令執行視覺問答和推理任務。",
        desc_kimi_k2_0905": "由 MoonshotAI 開發，以其業界領先的超長上下文窗口（200 萬 tokens）聞名。特別適合處理和分析海量文件，例如法律文件審閱、學術論文分析等。",
        desc_deepseek_v3_1": "由深度求索開發的強大免費模型。擁有極強的程式碼與數學能力，並支援多種語言。對於需要高度技術性分析且預算有限的開發者或學生來說，是絕佳的選擇。",
        desc_gpt_oss_20b": "OpenAI 的 200 億參數開源模型，提供了一個可靠且高效的基礎模型，適合進行微調或在資源受限的環境中部署。",
        desc_qwen3_235b": "通義千問的 2350 億參數開源模型，在多語言能力和通用知識方面表現強勁，是目前最強大的開源模型之一。",
        desc_deepseek_r1t2_chimera": "由 TNGtech 基於 Deepseek 微調的混合模型，旨在結合多種模型的優點，提供在特定領域（如創意寫作或邏輯推理）的增強性能。",
        desc_llama_3_3_70b": "由 Meta 開發的強大開源模型。經過大量高品質資料的訓練，它在通用對話、寫作和推理方面表現出色，並且擁有極高的社群支援度。",
        desc_qwen2_5_vl_72b": "由阿里巴巴開發的頂級多模態開源模型。它能同時理解高解析度的圖片與複雜的文字指令，在圖文問答、視覺推理和 OCR 等任務上表現傑出。",
        // Official Astras
    ...
    'en': {
        ...
        // ... (all the general English translations)
        versionNumber: 'Astra-nos-15.7.7',
        "model_descriptions_title": "Explore AI Models Tailored for You",
        "model_descriptions_subtitle": "We offer a range of top-tier models for different tasks. Use the filters below to find the perfect partner for your current job.",
        "desc_gemini_2_5_pro": "Google's flagship model. Natively supports image, audio, and video analysis with an ultra-long context window of up to 2 million tokens. Ideal for large-scale document review, complex multimodal reasoning, and deep code analysis.",
        "desc_gemini_2_5_flash_pv": "The preview version of Gemini 2.5 Flash, designed for applications requiring extreme speed and efficiency. Suitable for high-traffic summarization, translation, or real-time conversation tasks, making it a highly cost-effective choice.",
        "desc_gemini_2_5_flash": "A lightweight, high-speed model from Google that significantly reduces latency and cost while maintaining high-quality output. Perfect for scenarios needing rapid responses and large-scale deployment, like chatbots or content classification.",
        "desc_gemini_2_5_flash_lite_pv": "The nimblest preview version in the Flash series, optimized for mobile devices and edge computing. It boasts astonishing response speeds, suitable for simple commands, text filtering, or applications requiring embedded AI.",
        "desc_gpt_5_pro": "OpenAI's top-tier flagship model, featuring the strongest general reasoning and multimodal understanding capabilities currently available. Suited for the most complex tasks requiring deep thought and creativity, it's the first choice for tackling tough problems.",
        "desc_gpt_5": "OpenAI's core high-performance model, striking an excellent balance in general knowledge, reasoning, and multilingual abilities. It is the ideal choice for most professional writing, content generation, and complex Q&A tasks.",
        "desc_gpt_5_mini": "The lightweight workhorse of the GPT-5 series, offering powerful general capabilities at an extremely high value. Suitable for daily work, copywriting, email drafting, and other scenarios that require quick and reliable responses.",
        "desc_gpt_5_nano": "The most economical and fastest model in the GPT-5 series. Designed for simple tasks requiring lightning-fast responses, such as text classification, keyword extraction, or simple customer service Q&A.",
        "desc_gpt_4_1": "An advanced large language model from OpenAI, improved upon GPT-4, offering stronger reasoning and instruction-following capabilities, suitable for most professional scenarios.",
        "desc_gpt_4_1_mini": "A lightweight version of GPT-4.1 that provides faster speed and lower cost while maintaining relatively high quality, suitable for balanced applications requiring quick responses.",
        "desc_gpt_4_1_nano": "The fastest and most economical version in the GPT-4.1 series, optimized for simple, high-frequency tasks such as text classification, sentiment analysis, or simple Q&A.",
        "desc_gpt_5_codex": "A top-tier model born for programming. It not only generates high-quality code but also deeply understands existing codebases, debugs, writes test cases, and provides architectural suggestions, making it a powerful assistant for professional developers.",
        "desc_o3": "One of OpenAI's o3 series models, designed for complex tasks requiring multi-step thinking and logical chain reasoning. It excels at solving difficult math problems, strategic planning, and analyzing complex code.",
        "desc_o3_mini_high": "A high-spec version of the O3 Mini series, offering powerful reasoning capabilities close to O3 at a lower cost. It's a high-value choice for tasks requiring complex thought on a limited budget.",
        "desc_gpt_oss_120b": "A large open-source model from OpenAI with 120 billion parameters. It offers a balanced performance in general knowledge, reasoning, and coding abilities, making it a strong option within the open-source community.",
        "desc_claude_sonnet_4_5": "Anthropic's main model, striking an excellent balance between speed, intelligence, and cost. It particularly excels at handling enterprise-level tasks like data analysis, sales forecasting, and complex RAG applications, leading its class in accuracy.",
        "desc_claude_haiku_4_5": "Anthropic's fastest model, featuring top-tier visual processing capabilities. Suitable for scenarios requiring rapid responses and understanding of image content, such as real-time customer service, content moderation, or quick information extraction from images.",
        "desc_claude_sonnet_4": "One of Anthropic's Claude 4 series models, designed for enterprise applications requiring high reliability and safety. It places special emphasis on reducing harmful outputs and improving the accuracy of instruction following.",
        "desc_sonar_deep_research": "A model from Perplexity AI built for in-depth research. It can perform multi-step web searches, analyze, and synthesize information from numerous sources to produce insightful and detailed reports.",
        "desc_sonar": "Perplexity AI's core online model, combining a large language model with real-time web search capabilities to provide accurate, sourced answers to questions requiring the latest information.",
        "desc_deepseek_v3_1_terminus": "Deepseek's flagship paid model, a world leader in the fields of coding and mathematics. It not only writes high-quality code but also solves complex mathematical and logical problems, making it a powerful tool for technical experts.",
        "desc_grok_4_fast": "Developed by x-ai, known for its real-time information processing and unique sense of humor. Particularly suitable for tasks that require integrating the latest web information, performing quick fact-checks, or creative writing with a strong personality.",
        "desc_grok_code_fast_1": "A model from x-ai optimized for coding tasks, providing fast code generation, completion, and debugging capabilities, aimed at boosting developer productivity.",
        "desc_qwen3_coder": "Alibaba's Qwen series model dedicated to coding. It supports multiple programming languages and is deeply optimized for code generation and bug fixing.",
        "desc_qwen3_vl_235b": "Qwen's top-tier visual language model, capable of understanding and analyzing image content with extremely high precision and performing visual Q&A and reasoning based on complex instructions.",
        "desc_kimi_k2_0905": "Developed by MoonshotAI, famous for its industry-leading ultra-long context window (2 million tokens). It is particularly well-suited for processing and analyzing massive documents, such as legal document review or academic paper analysis.",
        "desc_deepseek_v3_1": "A powerful free model developed by Deepseek. It possesses extremely strong coding and mathematical abilities and supports multiple languages. An excellent choice for developers or students who require highly technical analysis on a limited budget.",
        "desc_gpt_oss_20b": "OpenAI's 20 billion parameter open-source model, providing a reliable and efficient base model suitable for fine-tuning or deployment in resource-constrained environments.",
        "desc_qwen3_235b": "Qwen's 235 billion parameter open-source model, demonstrating strong performance in multilingual capabilities and general knowledge, making it one of the most powerful open-source models currently available.",
        "desc_deepseek_r1t2_chimera": "A hybrid model fine-tuned by TNGtech based on Deepseek, designed to combine the advantages of multiple models to provide enhanced performance in specific domains like creative writing or logical reasoning.",
        "desc_llama_3_3_70b": "A powerful open-source model developed by Meta. Trained on a massive amount of high-quality data, it excels in general conversation, writing, and reasoning, and enjoys strong community support.",
        "desc_qwen2_5_vl_72b": "A top-tier multimodal open-source model from Alibaba. It can simultaneously understand high-resolution images and complex text instructions, performing exceptionally well on tasks like visual Q&A, visual reasoning, and OCR."
    },
        // Official Astras
    ...
    'fr': {
        ...
        // ... (toutes les traductions générales françaises)
        versionNumber: 'Astra-nos-15.7.7',
        "model_descriptions_title": "Découvrez des modèles d'IA sur mesure pour vous",
        "model_descriptions_subtitle": "Nous proposons une gamme de modèles de premier plan pour différentes tâches. Utilisez les filtres ci-dessous pour trouver le partenaire idéal pour votre mission actuelle.",
        "desc_gemini_2_5_pro": "Modèle phare de Google. Prend en charge nativement l'analyse d'images, d'audio et de vidéos avec une fenêtre de contexte ultra-longue allant jusqu'à 2 millions de jetons. Idéal pour l'examen de documents à grande échelle, le raisonnement multimodal complexe et l'analyse de code approfondie.",
        "desc_gemini_2_5_flash_pv": "La version préliminaire de Gemini 2.5 Flash, conçue pour les applications nécessitant une vitesse et une efficacité extrêmes. Convient aux tâches de résumé, de traduction ou de conversation en temps réel à fort trafic, ce qui en fait un choix très rentable.",
        "desc_gemini_2_5_flash": "Un modèle léger et rapide de Google qui réduit considérablement la latence et les coûts tout en maintenant une sortie de haute qualité. Parfait pour les scénarios nécessitant des réponses rapides et un déploiement à grande échelle, comme les chatbots ou la classification de contenu.",
        "desc_gemini_2_5_flash_lite_pv": "La version préliminaire la plus agile de la série Flash, optimisée pour les appareils mobiles et l'informatique en périphérie. Elle offre des vitesses de réponse étonnantes, adaptées aux commandes simples, au filtrage de texte ou aux applications nécessitant une IA intégrée.",
        "desc_gpt_5_pro": "Le modèle phare haut de gamme d'OpenAI, doté des plus fortes capacités de raisonnement général et de compréhension multimodale actuellement disponibles. Adapté aux tâches les plus complexes nécessitant une réflexion approfondie et de la créativité, c'est le premier choix pour résoudre les problèmes difficiles.",
        "desc_gpt_5": "Le modèle central haute performance d'OpenAI, offrant un excellent équilibre entre connaissances générales, raisonnement et capacités multilingues. C'est le choix idéal pour la plupart des tâches d'écriture professionnelle, de génération de contenu et de questions-réponses complexes.",
        "desc_gpt_5_mini": "Le cheval de bataille léger de la série GPT-5, offrant de puissantes capacités générales à un rapport qualité-prix extrêmement élevé. Convient au travail quotidien, à la rédaction publicitaire, à la rédaction d'e-mails et à d'autres scénarios nécessitant des réponses rapides et fiables.",
        "desc_gpt_5_nano": "Le modèle le plus économique et le plus rapide de la série GPT-5. Conçu pour les tâches simples nécessitant des réponses ultra-rapides, telles que la classification de texte, l'extraction de mots-clés ou les questions-réponses simples du service client.",
        "desc_gpt_4_1": "Un modèle de langage avancé d'OpenAI, amélioré par rapport à GPT-4, offrant des capacités de raisonnement et de suivi d'instructions plus fortes, adapté à la plupart des scénarios professionnels.",
        "desc_gpt_4_1_mini": "Une version légère de GPT-4.1 qui offre une vitesse plus rapide et un coût inférieur tout en maintenant une qualité relativement élevée, adaptée aux applications équilibrées nécessitant des réponses rapides.",
        "desc_gpt_4_1_nano": "La version la plus rapide et la plus économique de la série GPT-4.1, optimisée pour des tâches simples et à haute fréquence telles que la classification de texte, l'analyse des sentiments ou les questions-réponses simples.",
        "desc_gpt_5_codex": "Un modèle haut de gamme né pour la programmation. Il génère non seulement du code de haute qualité, mais comprend également en profondeur les bases de code existantes, débogue, écrit des cas de test et fournit des suggestions d'architecture, ce qui en fait un assistant puissant pour les développeurs professionnels.",
        "desc_o3": "L'un des modèles de la série o3 d'OpenAI, conçu pour les tâches complexes nécessitant une réflexion en plusieurs étapes et un raisonnement en chaîne logique. Il excelle dans la résolution de problèmes mathématiques difficiles, la planification stratégique et l'analyse de code complexe.",
        "desc_o3_mini_high": "Une version haut de gamme de la série O3 Mini, offrant des capacités de raisonnement puissantes proches de l'O3 à un coût inférieur. C'est un choix à haute valeur pour les tâches nécessitant une réflexion complexe avec un budget limité.",
        "desc_gpt_oss_120b": "Un grand modèle open-source d'OpenAI avec 120 milliards de paramètres. Il offre des performances équilibrées en connaissances générales, en raisonnement et en capacités de codage, ce qui en fait une option solide au sein de la communauté open-source.",
        "desc_claude_sonnet_4_5": "Le modèle principal d'Anthropic, offrant un excellent équilibre entre vitesse, intelligence et coût. Il excelle particulièrement dans le traitement de tâches de niveau entreprise comme l'analyse de données, la prévision des ventes et les applications RAG complexes, et se positionne en tête de sa catégorie en termes de précision.",
        "desc_claude_haiku_4_5": "Le modèle le plus rapide d'Anthropic, doté de capacités de traitement visuel de premier ordre. Adapté aux scénarios nécessitant des réponses rapides et la compréhension du contenu des images, comme le service client en temps réel, la modération de contenu ou l'extraction rapide d'informations à partir d'images.",
        "desc_claude_sonnet_4": "L'un des modèles de la série Claude 4 d'Anthropic, conçu pour les applications d'entreprise nécessitant une grande fiabilité et sécurité. Il met un accent particulier sur la réduction des sorties nuisibles et l'amélioration de la précision du suivi des instructions.",
        "desc_sonar_deep_research": "Un modèle de Perplexity AI conçu pour la recherche approfondie. Il peut effectuer des recherches web en plusieurs étapes, analyser et synthétiser des informations de nombreuses sources pour produire des rapports détaillés et perspicaces.",
        "desc_sonar": "Le modèle en ligne principal de Perplexity AI, combinant un grand modèle de langage avec des capacités de recherche web en temps réel pour fournir des réponses précises et sourcées aux questions nécessitant les informations les plus récentes.",
        "desc_deepseek_v3_1_terminus": "Le modèle payant phare de Deepseek, un leader mondial dans les domaines du codage et des mathématiques. Il écrit non seulement du code de haute qualité, mais résout également des problèmes mathématiques et logiques complexes, ce qui en fait un outil puissant pour les experts techniques.",
        "desc_grok_4_fast": "Développé par x-ai, connu pour son traitement de l'information en temps réel et son sens de l'humour unique. Particulièrement adapté aux tâches qui nécessitent d'intégrer les dernières informations du web, d'effectuer des vérifications rapides des faits ou pour l'écriture créative avec une forte personnalité.",
        "desc_grok_code_fast_1": "Un modèle de x-ai optimisé pour les tâches de codage, offrant une génération, une complétion et un débogage de code rapides, visant à augmenter la productivité des développeurs.",
        "desc_qwen3_coder": "Le modèle de la série Qwen d'Alibaba dédié au codage. Il prend en charge plusieurs langages de programmation et est profondément optimisé pour la génération et la correction de bogues de code.",
        "desc_qwen3_vl_235b": "Le modèle de langage visuel haut de gamme de Qwen, capable de comprendre et d'analyser le contenu d'images avec une très haute précision et d'exécuter des questions-réponses visuelles et des raisonnements basés sur des instructions complexes.",
        "desc_kimi_k2_0905": "Développé par MoonshotAI, célèbre pour sa fenêtre de contexte ultra-longue (2 millions de jetons), leader de l'industrie. Il est particulièrement bien adapté au traitement et à l'analyse de documents volumineux, tels que l'examen de documents juridiques ou l'analyse d'articles académiques.",
        "desc_deepseek_v3_1": "Un puissant modèle gratuit développé par Deepseek. Il possède des capacités de codage et de mathématiques extrêmement fortes et prend en charge plusieurs langues. Un excellent choix pour les développeurs ou les étudiants qui ont besoin d'une analyse hautement technique avec un budget limité.",
        "desc_gpt_oss_20b": "Le modèle open-source de 20 milliards de paramètres d'OpenAI, fournissant un modèle de base fiable et efficace, adapté au peaufinage ou au déploiement dans des environnements aux ressources limitées.",
        "desc_qwen3_235b": "Le modèle open-source de 235 milliards de paramètres de Qwen, démontrant de solides performances en capacités multilingues et en connaissances générales, ce qui en fait l'un des modèles open-source les plus puissants actuellement disponibles.",
        "desc_deepseek_r1t2_chimera": "Un modèle hybride affiné par TNGtech sur la base de Deepseek, conçu pour combiner les avantages de plusieurs modèles afin d'offrir des performances améliorées dans des domaines spécifiques comme l'écriture créative ou le raisonnement logique.",
        "desc_llama_3_3_70b": "Un puissant modèle open-source développé par Meta. Entraîné sur une grande quantité de données de haute qualité, il excelle dans la conversation générale, l'écriture et le raisonnement, et bénéficie d'un fort soutien de la communauté.",
        "desc_qwen2_5_vl_72b": "Un modèle multimodal open-source de premier plan d'Alibaba. Il peut comprendre simultanément des images haute résolution et des instructions textuelles complexes, offrant des performances exceptionnelles pour des tâches telles que les questions-réponses visuelles, le raisonnement visuel et l'OCR."
    }
};
        // Official Astras
