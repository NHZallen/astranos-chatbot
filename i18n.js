window.i18n = {
    'zh-TW': {
        ...
        versionNumber: 'Astra-nos-15.7.11',
        ...
        model_gemini_2_5_pro_desc: '費用-免費 (5次/分鐘、100次/天)',
        model_gemini_2_5_flash_pv_desc: '費用-免費 (10次/分鐘、250次/天)',
        model_gemini_2_5_flash_desc: '費用-免費 (10次/分鐘、250次/天)',
        model_gemini_2_5_flash_lite_pv_desc: '費用-免費 (15次/分鐘、1000次/天)',
        // OpenRouter Free
        model_gpt_oss_20b_desc: '費用-免費 (20次/分鐘、50次/天)',
        model_deepseek_r1t2_chimera_desc: '費用-免費 (20次/分鐘、50次/天)',
        model_minimax_m2_desc: '費用-免費 (20次/分鐘、50次/天)',
        model_nemotron_nano_12b_v2_vl_desc: '費用-免費 (20次/分鐘、50次/天)',
        model_polaris_alpha_desc: '一款高效能的測試版免費模型，由 Polaris Alpha 提供，適合多種通用任務。',
        // OpenAI Paid
        ...
        model_qwen3_coder_exact_desc: '百萬輸入/0.38$、百萬輸出/1.53$',
        model_qwen3_vl_8b_instruct_desc: '百萬輸入/0.18$、百萬輸出/0.69$',
        model_qwen3_vl_32b_instruct_desc: '百萬輸入/0.35$、百萬輸出/1.10$',
        ...
        model_qwen2_5_vl_72b_instruct_desc: '百萬輸入/0.08$、百萬輸出/0.33$',
        // MoonshotAI Paid
        model_kimi_k2_0905_desc: '百萬輸入/0.39$、百萬輸出/1.90$',
        model_kimi_k2_thinking_desc: '百萬輸入/0.60$、百萬輸出/2.50$',
        // Official Astras
    ...
    'en': {
        ...
        // Model Descriptions & Limits
        model_gemini_2_5_pro_desc: 'Cost - Free (5 req/min, 100 req/day)',
        model_gemini_2_5_flash_pv_desc: 'Cost - Free (10 req/min, 250 req/day)',
        model_gemini_2_5_flash_desc: 'Cost - Free (10 req/min, 250 req/day)',
        model_gemini_2_5_flash_lite_pv_desc: 'Cost - Free (15 req/min, 1000 req/day)',
        model_gpt_oss_20b_desc: 'Cost - Free (20 req/min, 50 req/day)',
        model_deepseek_r1t2_chimera_desc: 'Cost - Free (20 req/min, 50 req/day)',
        model_minimax_m2_desc: 'Cost - Free (20 req/min, 50 req/day)',
        model_nemotron_nano_12b_v2_vl_desc: 'Cost - Free (20 req/min, 50 req/day)',
        model_polaris_alpha_desc: 'A high-performance, free beta model by Polaris Alpha, suitable for various general tasks.',
        ...
        model_qwen3_coder_exact_desc: '$0.38/M input, $1.53/M output',
        model_qwen3_vl_8b_instruct_desc: '$0.18/M input, $0.69/M output',
        model_qwen3_vl_32b_instruct_desc: '$0.35/M input, $1.10/M output',
        ...
        model_qwen2_5_vl_72b_instruct_desc: '$0.08/M input, $0.33/M output',
        model_kimi_k2_0905_desc: '$0.39/M input, $1.90/M output',
        model_kimi_k2_thinking_desc: '$0.60/M input, $2.50/M output',
        // Official Astras
    ...
    'fr': {
        ...
        // Model Descriptions & Limits
        model_gemini_2_5_pro_desc: 'Coût - Gratuit (5 req/min, 100 req/jour)',
        model_gemini_2_5_flash_pv_desc: 'Coût - Gratuit (10 req/min, 250 req/jour)',
        model_gemini_2_5_flash_desc: 'Coût - Gratuit (10 req/min, 250 req/jour)',
        model_gemini_2_5_flash_lite_pv_desc: 'Coût - Gratuit (15 req/min, 1000 req/jour)',
        ...
        model_minimax_m2_desc: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_nemotron_nano_12b_v2_vl_desc: 'Coût - Gratuit (20 req/min, 50 req/jour)',
        model_polaris_alpha_desc: 'Un modèle bêta gratuit et performant de Polaris Alpha, adapté à diverses tâches générales.',
        ...
        model_qwen3_coder_exact_desc: '0,38 $/M entrée, 1,53 $/M sortie',
        model_qwen3_vl_8b_instruct_desc: '0,18 $/M entrée, 0,69 $/M sortie',
        model_qwen3_vl_32b_instruct_desc: '0,35 $/M entrée, 1,10 $/M sortie',
        ...
        model_qwen2_5_vl_72b_instruct_desc: '0,08 $/M entrée, 0,33 $/M sortie',
        model_kimi_k2_0905_desc: '0,39 $/M entrée, 1,90 $/M sortie',
        model_kimi_k2_thinking_desc: '0,60 $/M entrée, 2,50 $/M sortie',
        // Official Astras
