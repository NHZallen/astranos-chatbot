window.i18n = {
  'zh-TW': {
    ...
    version: '版本號',
    versionInfo: '版本資訊',
    versionNumber: 'Astra-nos-14.8.9',
    ...
    searching: '正在搜尋中...',
    keywordGenerationFailed: '無法從您的查詢中提取關鍵字。',
    ...
    moveToTrashConfirmText: '個對話移至垃圾桶嗎？',
    batchMoveToTrashSuccess: '已成功將',
    movedToTrashText: '個對話移至垃圾桶。',
    itemRestored: '項目已還原。',
    ...
    model_ultra_desc: '最強大、最具實驗性的旗艦模型，適合處理高度複雜、多面向的研究與分析任務。注意：對話內容可能被模型提供方檢視。',
    model_ultra_limits: '20次/分鐘、50次/天',
    model_pro_desc: '頂級效能模型，在速度、推理能力與準確性之間達到絕佳平衡，是專業寫作、程式設計與綜合分析的首選。',
    model_pro_limits: '10次/分鐘、250次/天',
    model_plus_desc: '高速通用模型，為日常任務、長文處理與快速問答提供穩定可靠的表現，兼具效率與成本效益。',
    model_plus_limits: '15次/分鐘、1000次/天',
    model_mini_desc: '深度推理模型，專為需要多步驟思考、深度問答與複雜邏輯拆解的任務而設計。',
    model_mini_limits: '20次/分鐘、50次/天',
    model_mill_desc: '大規模開源模型，具備廣泛的知識與優異的泛用推理能力，適合處理跨領域的大型任務。',
    model_mill_limits: '20次/分鐘、50次/天',
    model_nano_desc: '程式設計專用模型，精通多種程式語言與技術框架，是開發、除錯與學習程式的最佳助手。',
    model_nano_limits: '20次/分鐘、50次/天',
    model_pico_desc: '輕量級高效模型，提供極快的反應速度與優異的多語言能力，適合需要即時互動與跨語言溝通的場景。',
  ...
  'en': {
    ...
    versionNumber: 'Astra-nos-14.8.9',
    viewUpdateHistory: 'View Version Update History',
    enableUpdateNotifications: 'Enable update notification pop-ups',
    ...
    searching: 'Searching...',
    keywordGenerationFailed: 'Could not extract keywords from your query.',
    ...
    moveToTrashConfirmText: 'conversations to the trash?',
    batchMoveToTrashSuccess: 'Successfully moved',
    movedToTrashText: 'conversations to the trash.',
    ...
    permanentDeleteTitle: 'Permanent Deletion Confirmation',
    ...
    iGotIt: 'I Got It',
    updateHistory: 'Version Update History',
    noUpdateHistory: 'No update history available.',

    // Model Descriptions & Limits
    model_ultra_desc: 'The most powerful and experimental flagship model, suitable for highly complex, multifaceted research and analysis tasks. Note: Conversations may be reviewed by the model provider.',
    model_ultra_limits: '20 reqs/minute, 50 reqs/day',
    model_pro_desc: 'A top-tier performance model that strikes an excellent balance between speed, reasoning, and accuracy. The top choice for professional writing, coding, and comprehensive analysis.',
    model_pro_limits: '10 reqs/min, 250 reqs/day',
    model_plus_desc: 'A high-speed, general-purpose model providing stable and reliable performance for daily tasks, long-text processing, and quick Q&A, balancing efficiency and cost-effectiveness.',
    model_plus_limits: '15 reqs/min, 1000 reqs/day',
    model_mini_desc: 'A deep reasoning model designed for tasks requiring multi-step thinking, in-depth Q&A, and complex logical decomposition.',
    model_mini_limits: '20 reqs/min, 50 reqs/day',
    model_mill_desc: 'A large-scale open-source model with extensive knowledge and excellent general-purpose reasoning, suitable for handling large, cross-domain tasks.',
    model_mill_limits: '20 reqs/min, 50 reqs/day',
    model_nano_desc: 'A specialized model for programming, proficient in multiple programming languages and technical frameworks. The best assistant for development, debugging, and learning to code.',
    model_nano_limits: '20 reqs/min, 50 reqs/day',
    model_pico_desc: 'A lightweight and efficient model offering extremely fast response times and excellent multilingual capabilities, ideal for scenarios requiring real-time interaction and cross-lingual communication.',
  ...
  'fr': {
    ...
    keywordGenerationFailed: 'Impossible d\'extraire les mots-clés de votre requête.',
    noResultsFound: 'Aucune conversation correspondante trouvée.',
    noMessages: 'Cette conversation ne contient aucun message.',
    ...
    chatMovedToTrash: 'Le chat a été déplacé dans la corbeille.',
    confirmBatchMoveToTrash: 'Êtes-vous sûr de vouloir déplacer ces',
    moveToTrashConfirmText: 'conversations vers la corbeille ?',
    batchMoveToTrashSuccess: 'Déplacé avec succès',
    movedToTrashText: 'conversations vers la corbeille.',
    itemRestored: 'Élément restauré.',
    confirmPermanentDelete: 'Ceci supprimera définitivement la conversation et ne pourra pas être annulé. Êtes-vous sûr ?',
    permanentDeleteTitle: 'Confirmation de suppression permanente',
    itemPermanentlyDeleted: 'Élément supprimé définitivement.',
    viewTrashItem: 'Afficher l\'élément supprimé',
    ...
    noUpdateHistory: 'Aucun historique des mises à jour.',

    // Model Descriptions & Limits
    model_ultra_desc: 'Le modèle phare le plus puissant et expérimental, adapté aux tâches de recherche et d\'analyse très complexes et multifacettes. Note : Les conversations peuvent être examinées par le fournisseur du modèle.',
    model_ultra_limits: '20 reqs/minute, 50 reqs/jour',
    model_pro_desc: 'Un modèle de performance de premier plan qui offre un excellent équilibre entre vitesse, raisonnement et précision. Le premier choix pour l\'écriture professionnelle, le codage et l\'analyse complète.',
    model_pro_limits: '10 reqs/min, 250 reqs/jour',
    model_plus_desc: 'Un modèle polyvalent à grande vitesse offrant des performances stables et fiables pour les tâches quotidiennes, le traitement de textes longs et les questions-réponses rapides, alliant efficacité et rentabilité.',
    model_plus_limits: '15 reqs/min, 1000 reqs/jour',
    model_mini_desc: 'Un modèle de raisonnement profond conçu pour les tâches nécessitant une réflexion en plusieurs étapes, des questions-réponses approfondies et une décomposition logique complexe.',
    model_mini_limits: '20 reqs/min, 50 reqs/jour',
    model_mill_desc: 'Un modèle open source à grande échelle doté de connaissances étendues et d\'un excellent raisonnement polyvalent, adapté à la gestion de grandes tâches interdomaines.',
    model_mill_limits: '20 reqs/min, 50 reqs/jour',
    model_nano_desc: 'Un modèle spécialisé pour la programmation, compétent dans plusieurs langages de programmation et frameworks techniques. Le meilleur assistant pour le développement, le débogage et l\'apprentissage du code.',
    model_nano_limits: '20 reqs/min, 50 reqs/jour',
    model_pico_desc: 'Un modèle léger et efficace offrant des temps de réponse extrêmement rapides et d\'excellentes capacités multilingues, idéal pour les scénarios nécessitant une interaction en temps réel et une communication interlinguistique.',
