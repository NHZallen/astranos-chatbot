window.i18n = {
    'zh-TW': {
        ...
        versionNumber: 'Astra-nos-15.3.4',
        ...
        model_Pro Max_desc: '深度推理專長，專業研究與複雜決策首選。',
        model_Pro Max_limits: '5次/分鐘、100次/天',
        model_Pro PV_desc: '測試最新功能，兼具速度與多模態體驗。',
        model_Pro PV_limits: '10次/分鐘、250次/天',
        model_Pro_desc: '高效多模態模型，影像與文字分析並行。',
        model_Pro_limits: '10次/分鐘、250次/天',
        model_Plus PV_desc: '超輕量快速，適合低延遲與日常應用。',
        model_Plus PV_limits: '15次/分鐘、1000次/天',
    ...
    'en': {
        ...
        model_Pro Max_desc: 'Expert in deep reasoning, best choice for professional research and complex decisions.',
        model_Pro Max_limits: '5 req/min, 100 req/day',
        model_Pro PV_desc: 'Preview latest features, combining speed with multimodal capabilities.',
        model_Pro PV_limits: '10 req/min, 250 req/day',
        model_Pro_desc: 'Efficient multimodal model for both image and text analysis.',
        model_Pro_limits: '10 req/min, 250 req/day',
        model_Plus PV_desc: 'Lightweight and fast, ideal for low-latency and everyday applications.',
        model_Plus PV_limits: '15 req/min, 1000 req/day',
    ...
    'fr': {
        ...
        model_Pro Max_desc: 'Spécialiste du raisonnement profond, choix idéal pour recherche professionnelle et décisions complexes.',
        model_Pro Max_limits: '5 req/min, 100 req/jour',
        model_Pro PV_desc: 'Aperçu des dernières fonctions, alliant rapidité et capacités multimodales.',
        model_Pro PV_limits: '10 req/min, 250 req/jour',
        model_Pro_desc: 'Modèle multimodal efficace pour analyser textes et images.',
        model_Pro_limits: '10 req/min, 250 req/jour',
        model_Plus PV_desc: 'Léger et rapide, idéal pour faible latence et usages quotidiens.',
        model_Plus PV_limits: '15 req/min, 1000 req/jour',
