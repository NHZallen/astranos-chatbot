window.i18n = {
    'zh-TW': {
        ...
        versionNumber: 'Astra-nos-16.2.0', // 已更新版本號
        ...
        importDataDesc: '選擇一個之前匯出的 `.json` 或 `.zip` 檔案。目前的所有資料將會被覆蓋。', // Updated
        selectFile: '選擇檔案',
        ...
        importDataDescAuth: '選擇一個之前匯出的 `.json` 或 `.zip` 檔案。您輸入的帳號密碼將用於驗證備份檔案的所有權。', // Updated
        ...
        submitting: '提交中...',
        compressingImages: '正在壓縮圖片...', // New
        processingFiles: '正在處理檔案...', // New
        zipNoJson: 'ZIP 檔案中找不到 JSON 資料。', // New
    ...
    'en': {
        ...
        versionNumber: 'Astra-nos-16.2.0', // Updated
