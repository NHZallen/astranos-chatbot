const updateLogs = [
    ...
    "date": "2025-11-15",
    "content": [
        "<strong>【體驗再升級：無感自動更新 & 極速啟動】</strong>",
        "在 15.10.1 版本中，我們徹底重構了 PWA 的更新機制，為您帶來如原生 App 般流暢、無干擾的自動更新體驗。現在，告別手動重新整理的提示，享受真正的無縫升級！",
        "<strong>✨ 核心體驗革新：</strong>",
        "<ul><li><strong>實現「無感背景更新」：</strong> 您不再會看到「應用程式已更新，請重新整理」的彈窗。Astra 現在會在背景為您靜默下載最新版本。您只需要在下一次開啟應用時，即可自動使用到所有新功能，整個過程完全不會打斷您當前的工作。</li><li><strong>極速啟動優化 (Stale-While-Revalidate)：</strong> 為了極致的啟動速度，應用程式現在會永遠優先從快取中載入，確保秒開體驗。同時，它會在背景檢查並抓取更新，兼顧了速度與即時性。</li><li><strong>提升離線可靠性：</strong> 新的快取策略也意味著更強的穩定性。即使在網路環境不佳、背景更新失敗的情況下，您依然可以順暢地開啟並使用已快取的應用程式版本。</li></ul>",
        "我們相信，好的技術應該是隱形的。這次更新是我們對提升您日常使用體驗的又一次努力。感謝您對極致體驗的追求，這激勵我們不斷完善 Astra。<br><br>Astra 開發團隊 敬上"
    ]
},
        {
    "version": "15.10.0",
