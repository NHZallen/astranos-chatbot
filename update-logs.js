const updateLogs = [
    ...
    "content": [
        ...
        "<ul><li><strong>全新流式輸出引擎：</strong> 我們徹底重寫了訊息的顯示方式！新的「幀同步渲染」技術能真實反映模型原始的輸出速度，徹底告別了「模型已輸出完，文字還在慢慢打」的延遲感。經過實測，新引擎將文字渲染的追趕延遲<strong>從平均 2400 毫秒大幅降低至 140 毫秒</strong>，為您帶來近乎同步的視覺體驗。</li><li><strong>操作流程簡化：</strong> 我們聽取了您的建議，移除了「點兩下才傳送」的二次確認機制。現在，您的每一次點擊都將直接、快速地發送訊息，讓靈感與對話暢行無阻。</li></ul>",
